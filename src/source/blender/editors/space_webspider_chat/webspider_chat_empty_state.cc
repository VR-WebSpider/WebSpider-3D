...
static const char *g_empty_prompt_texts[CHAT_EMPTY_PROMPT_COUNT] = {
    "Tell me about the features in WebSpider 3D",
...
const char *g_empty_prompt_modes[CHAT_EMPTY_PROMPT_COUNT] = {
    "AGENT",    /* "Tell me about the features in WebSpider 3D" */
 ...
 * webspider_ai_chat_generate_type identifiers). Empty string means no generate
 * type should be set.
 */
                                  ...
                                  int winy)
{
   ...
   * webspider_ai chat editor can be dragged tiny too) — a half-clipped
   ...
   * webspider_ai_chat_main_region.cc and webspider_ai_chat_hit_testing.cc don't
   ...
   * never shows the hand cursor (see webspider_ai_chat_main_region_cursor) —
