 ...
 * \brief Selection and hit detection utilities for WebSpider AI space
 */
...
/* -------------------------------------------------------------------- */
/** \name WebSpider AI3D Preview Selection
 * \{ */
                                        ...
                                        int mouse_y)
{
  ...
  /* Layout constants from webspider_ai_intern.hh (must match drawing code) */
