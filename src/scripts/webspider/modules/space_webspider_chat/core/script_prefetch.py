...
class ScriptAssetPrefetch:
    ...
    def __init__(self, urls: list[str]):
        ...
        thread = threading.Thread(
            target=self._run, args=(urls,), name="webspider3d-script-prefetch", daemon=True
        )
        thread.start()
    ...
    def _run(self, urls: list[str]) -> None:
        ...
        try:
            ...
            from webspider.modules.paint.layered_build.download import download_to_tempfile
