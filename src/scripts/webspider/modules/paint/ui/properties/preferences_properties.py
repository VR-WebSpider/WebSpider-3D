...
"""Property definitions for WebSpider 3D preferences (migrated from WebSpider 3D Paint addon preferences)"""
...
class WebSpider 3DPaintPreferences(bpy.types.PropertyGroup):
    """Preferences for WebSpider 3D paint system (migrated from WebSpider 3D Paint addon preferences)"""
...
def register():
    ...
    if not hasattr(bpy.types.Scene, 'webspider3d_paint_preferences'):
        bpy.types.Scene.webspider3d_paint_preferences = bpy.props.PointerProperty(type=WebSpider 3DPaintPreferences)


def unregister():
    """Unregister preferences properties"""
    # Unregister scene property
    if hasattr(bpy.types.Scene, 'webspider3d_paint_preferences'):
        del bpy.types.Scene.webspider3d_paint_preferences
