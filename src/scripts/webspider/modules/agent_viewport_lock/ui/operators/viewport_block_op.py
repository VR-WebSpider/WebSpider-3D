...
class WEBSPIDER_OT_agent_viewport_block(Operator):
    ...
    bl_idname = "webspider.agent_viewport_block"
    ...
    def _on_toast_control(region, event) -> bool:
        ...
        try:
            from webspider.modules.common.notifications.toast_renderer import (
...
classes = (WEBSPIDER_OT_agent_viewport_block,)
