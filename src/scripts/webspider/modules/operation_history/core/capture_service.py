...
Follows the WebSpider 3D handler pattern (scene_graph/core/watcher.py + paint ui_handlers.py):
...
from ...space_webspider_chat.constants import SessionState
from ...space_webspider_chat.core.session import get_session_manager
