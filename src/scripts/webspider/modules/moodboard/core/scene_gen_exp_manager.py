...
class SceneGenExpManager:
    ...
    def _attach_imagegen_listener(self, job_id: str, object_index: int, label: str):
        ...
        from webspider.modules.common.job_queue import get_queue, JobState, TERMINAL_STATES
        from webspider.modules.common.job_queue.constants import FEATURE_IMAGEGEN
    ...
    def _post_process_moodboard_image(self, obj, object_index: int, label: str):
        ...
        if not scene.webspider_ai_moodboard_images:
            return
        mb_item = scene.webspider_ai_moodboard_images[-1]
