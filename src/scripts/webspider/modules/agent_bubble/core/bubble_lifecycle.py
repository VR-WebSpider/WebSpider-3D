...
from webspider.modules.agent_bubble.core.bubble_state import (
...
def close_restored_agent_bubble_windows() -> int:
    """Close AGENT_BUBBLE windows restored from saved .webspider3d files.
...
def reset_restored_bubbles_after_load():
    ...
    from webspider.modules.agent_bubble.core.bubble_autoshow import autoshow_bubble
...
def load_autoshow_tick():
    """Retry opening a clean bubble after loading an existing .webspider3d file."""
...
def _load_autoshow_tick_inner():
    ...
    from webspider.modules.agent_bubble.core.bubble_autoshow import try_invoke_bubble as _try_invoke_bubble
