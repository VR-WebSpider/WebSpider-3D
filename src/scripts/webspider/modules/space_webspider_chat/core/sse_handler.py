...
def _try_refresh_token() -> str:
    ...
    """
    try:
        from webspider.modules.auth.core.auth import refresh_access_token, get_access_token
...
class SSEStreamHandler:
    ...
    def start_stream(
        ...
        self._thread.name = "WebSpider 3DSSEStream"
        self._thread.start()
    ...
    def start_input_stream(
        ...
        self._thread.name = "WebSpider 3DInputStream"
        self._thread.start()
