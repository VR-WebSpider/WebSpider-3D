...
"""Unit tests for space_webspider_chat.constants module.
...
class TestJSONRPCErrorCode(unittest.TestCase):
    ...
    def test_standard_codes(self):
        from webspider.modules.space_webspider_chat.constants import JSONRPCErrorCode
...
class TestStreamingConstants(unittest.TestCase):
    ...
    def test_streaming_batch_limit(self):
        from webspider.modules.space_webspider_chat.constants import STREAMING_BATCH_LIMIT
        self.assertEqual(STREAMING_BATCH_LIMIT, 8)

    def test_timer_interval(self):
        from webspider.modules.space_webspider_chat.constants import TIMER_INTERVAL
        self.assertAlmostEqual(TIMER_INTERVAL, 1 / 60, places=4)

    def test_script_timeout_threshold(self):
        from webspider.modules.space_webspider_chat.constants import SCRIPT_TIMEOUT_THRESHOLD
...
class TestImageConstants(unittest.TestCase):
    ...
    def test_supported_formats(self):
        from webspider.modules.space_webspider_chat.constants import SUPPORTED_IMAGE_FORMATS
...
class TestWebSocketConstants(unittest.TestCase):
    ...
    def test_close_code(self):
        from webspider.modules.space_webspider_chat.constants import WS_CLOSE_AUTH_FAILED
    ...
    def test_agent_chat_endpoint(self):
        from webspider.modules.space_webspider_chat.constants import AGENT_CHAT_ENDPOINT
        self.assertIn("/agent/chat", AGENT_CHAT_ENDPOINT)

    def test_agent_input_endpoint(self):
        from webspider.modules.space_webspider_chat.constants import AGENT_INPUT_ENDPOINT
    ...
    def test_sse_read_timeout(self):
        ...
        # for 10+ minutes.
        from webspider.modules.space_webspider_chat.constants import SSE_READ_TIMEOUT
...
class TestUIConstants(unittest.TestCase):
    ...
    def test_max_message_length(self):
        from webspider.modules.space_webspider_chat.constants import MAX_MESSAGE_LENGTH
