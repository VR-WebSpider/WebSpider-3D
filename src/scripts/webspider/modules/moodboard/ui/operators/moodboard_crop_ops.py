...
class WEBSPIDER_AI_OT_moodboard_crop_tool(Operator):
    """Activate crop tool - drag handles to define crop region, Enter to apply"""
    bl_idname = "webspider_ai.moodboard_crop_tool"
    bl_label = "Crop Tool"
    ...
    def modal(self, context, event):
        ...
        if event.type == 'RET' and event.value == 'PRESS':
            context.window.cursor_modal_restore()
            bpy.ops.webspider_ai.moodboard_apply_crop()
            return {'FINISHED'}
...
class WEBSPIDER_AI_OT_moodboard_apply_crop(Operator):
    """Apply the crop to the selected image"""
    bl_idname = "webspider_ai.moodboard_apply_crop"
    bl_label = "Apply Crop"
    ...
    def execute(self, context):
        ...
        bpy.ops.webspider_ai.moodboard_crop_image(
...
classes = (
    WEBSPIDER_AI_OT_moodboard_crop_tool,
    WEBSPIDER_AI_OT_moodboard_apply_crop,
)
