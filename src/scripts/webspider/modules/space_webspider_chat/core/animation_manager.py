...
"""
WebSpider Chat Animation Manager
        ...
        if not is_sse_timer_active():
            for window in bpy.context.window_manager.windows:
                for area in window.screen.areas:
                    # The loader/spinner renders both in the WEBSPIDER_AI_CHAT
                    ...
                    # the bubble is visible, so tagging WEBSPIDER_AI_CHAT alone left
...
# wmTimer in webspider_chat_main_region.cc) — this function only guarantees the
