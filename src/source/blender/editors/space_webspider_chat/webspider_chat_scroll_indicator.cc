...
void webspider_ai_chat_update_scroll_indicator(SpaceWebSpider AIChat *swebspider_ai,
                                        ARegion *region,
                                        int msg_count)
{
...
void webspider_ai_chat_trigger_scroll_bounce(SpaceWebSpider AIChat *swebspider_ai)
{
  WebSpider AIChatRuntime *rt = webspider_ai_chat_ensure_runtime(swebspider_ai);
...
void webspider_ai_chat_draw_scroll_indicator(SpaceWebSpider AIChat *swebspider_ai, ARegion *region)
{
  WebSpider AIChatRuntime *rt = webspider_ai_chat_ensure_runtime(swebspider_ai);
  if (!rt->scroll_indicator_visible) {
    return;
...
bool webspider_ai_chat_handle_scroll_indicator_click(SpaceWebSpider AIChat *swebspider_ai,
                                               ARegion *region,
                                               float mouse_x,
                                               float mouse_y)
{
