...
"""Height baking operations - utilities for baking height/displacement data."""
...
from ....core.node.get_nodes import get_active_mat_output_node, get_material_output
...
def get_bake_max_height(root_ch, mat=None, node=None, tex=None, emit=None):
    ...
    from ..utils.bake_settings_manager import (
        prepare_bake_settings,
        recover_bake_settings,
        remember_before_bake,
    )
    from ..utils.bake_vcol_utils import bake_object_op
