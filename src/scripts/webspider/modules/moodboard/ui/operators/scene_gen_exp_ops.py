...
class WEBSPIDER_AI_OT_scene_gen_exp_pick_image(Operator):
    """Select an image file for label extraction"""

    bl_idname = "webspider_ai.scene_gen_exp_pick_image"
    bl_label = "Pick Image"
...
class WEBSPIDER_AI_OT_scene_gen_exp_remove_image(Operator):
    """Remove the input image from Scene Gen Experimental tab"""

    bl_idname = "webspider_ai.scene_gen_exp_remove_image"
...
class WEBSPIDER_AI_OT_scene_gen_exp_toggle_all(Operator):
    """Toggle all labels selected/deselected"""

    bl_idname = "webspider_ai.scene_gen_exp_toggle_all"
    bl_label = "Toggle All"
...
class WEBSPIDER_AI_OT_scene_gen_exp_generate_images(Operator):
    """Generate one image per selected detected object (Step 2)"""

    bl_idname = "webspider_ai.scene_gen_exp_generate_images"
    ...
    def execute(self, context):
        ...
        if getattr(scene, 'webspider_ai_scene_gen_exp_is_processing', False):
...
class WEBSPIDER_AI_OT_scene_gen_exp_clear(Operator):
    """Clear all Scene Gen Experimental results and reset state"""

    bl_idname = "webspider_ai.scene_gen_exp_clear"
    bl_label = "Clear"
...
class WEBSPIDER_AI_OT_scene_gen_exp_extract_labels(Operator):
    """Extract labels from the input image"""

    bl_idname = "webspider_ai.scene_gen_exp_extract_labels"
...
class WEBSPIDER_AI_OT_scene_gen_exp_generate_hp(Operator):
    """Generate HP meshes from selected moodboard images (Step 3)"""

    bl_idname = "webspider_ai.scene_gen_exp_generate_hp"
...
class WEBSPIDER_AI_OT_scene_gen_exp_generate_lp(Operator):
    """Generate LP meshes from selected HP viewport objects (Step 4)"""

    bl_idname = "webspider_ai.scene_gen_exp_generate_lp"
...
classes = (
    WEBSPIDER_AI_OT_scene_gen_exp_pick_image,
    WEBSPIDER_AI_OT_scene_gen_exp_remove_image,
    WEBSPIDER_AI_OT_scene_gen_exp_clear,
    WEBSPIDER_AI_OT_scene_gen_exp_extract_labels,
    WEBSPIDER_AI_OT_scene_gen_exp_toggle_all,
    WEBSPIDER_AI_OT_scene_gen_exp_generate_images,
    WEBSPIDER_AI_OT_scene_gen_exp_generate_hp,
    WEBSPIDER_AI_OT_scene_gen_exp_generate_lp,
)
